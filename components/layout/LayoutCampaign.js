...
import HeaderV2 from "./HeaderCampaign";
import Sidebar from "./Sidebar";
import { useRouter } from "next/router";

const LayoutCampaign = ({ children, headerStyle, currentPage }) => {
  ...
  return (
    <>
      ...
      <HeaderV2 handleOpen={handleOpen} headerStyle={headerStyle} activePage={currentPage}/>
